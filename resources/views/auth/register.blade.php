@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'register', 'title' => __('Sistema de votaciones ITESG')])
          ...
          <div class="card-body ">
            ...
            <div class="bmd-form-group{{ $errors->has('password_confirmation') ? ' has-danger' : '' }} mt-3">
              <div class="input-group">
                ...
                <input type="password" name="password_confirmation" id="password_confirmation" class="form-control" placeholder="{{ __('Confirma contraseña') }}" required>
              </div>
            ...
            <div class="form-check mr-auto ml-3 mt-3">
              <label class="form-check-label">
                ...
                {{ __('Estoy de acuerdo con ') }} <a href="#">{{ __('las políticas de privacidad') }}</a>
              </label>
            </div>
          </div>
