@extends('layouts.app', ['activePage' => 'user-management', 'titlePage' => __('Administración usuarios')])
            ...
            <div class="card ">
              ...
              <div class="card-body ">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('apellido_paterno') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('apellido_paterno') ? ' is-invalid' : '' }}" name="apellido_paterno" id="input-ap" type="text" placeholder="{{ __('Apellido paterno') }}" value="{{ old('apellido_paterno') }}" required="true" aria-required="true"/>
                      @if ($errors->has('apellido_paterno'))
                        <span id="name-error" class="error text-danger" for="input-ap">{{ $errors->first('apellido_paterno') }}</span>
                      @endif
                    </div>
                  </div>
                </div>
                 <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('apellido_materno') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('apellido_materno') ? ' is-invalid' : '' }}" name="apellido_materno" id="input-am" type="text" placeholder="{{ __('Apellido materno') }}" value="{{ old('apellido_materno') }}" required="true" aria-required="true"/>
                      @if ($errors->has('apellido_materno'))
                        <span id="name-error" class="error text-danger" for="input-am">{{ $errors->first('apellido_materno') }}</span>
                      @endif
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" id="input-email" type="email" placeholder="{{ __('Correo') }}" value="{{ old('email') }}" required />
                      @if ($errors->has('email'))
